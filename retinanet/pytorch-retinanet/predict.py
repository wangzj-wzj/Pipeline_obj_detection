...
#                print(cropped)
                with tf.Graph().as_default():
                    ...
                    with tf.Session() as sess:
                        ...
                        print(max_index)
                        resu_dict.setdefault(key1,[]).append(x1)
                        resu_dict.setdefault(key1,[]).append(y1)
                        resu_dict.setdefault(key1,[]).append(x2)
                        resu_dict.setdefault(key1,[]).append(y2)
                        resu_dict.setdefault(key2,[]).append(max_index)
...
if __name__ == '__main__':
 predict('/home/wangzj/WORK/kaiguan/csv/predict.csv')
